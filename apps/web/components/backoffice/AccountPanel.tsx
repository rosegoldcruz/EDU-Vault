    ...
    <section className="space-y-6">
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        <div className="iv-panel p-4">
          ...
          <p className="text-sm text-white break-all">{profile?.email ?? 'No email on file'}</p>
        </div>
        <div className="iv-panel p-4">
        ...
        <div className="iv-panel p-4">
          ...
          <p className="text-sm text-white">{profile?.role ?? 'MEMBER'}</p>
        </div>
        <div className="iv-panel p-4">
          <p className="iv-label-muted mb-2">Referral code</p>
          <p className="text-sm text-white">{profile?.referral_code ?? 'Unavailable'}</p>
        </div>
        <div className="iv-panel p-4">
          <p className="iv-label-muted mb-2">EVM Wallet</p>
          <p className="text-sm text-white break-all">{profile?.evm_wallet_address ?? 'No EVM wallet linked'}</p>
        </div>
        <div className="iv-panel p-4">
        ...
        <div className="iv-panel p-4">
          ...
          <p className="text-sm text-white">{profile?.vault_xp?.toLocaleString() ?? '0'}</p>
        </div>
      </div>
    </section>
  )
