...
const CSS = `
  ...
  *{box-sizing:border-box;margin:0;padding:0;}
  ...
  .iv-eyebrow{font-family:var(--font-mono);font-size:9px;letter-spacing:3px;color:var(--electric-green);margin-bottom:10px;}
  ...
  .iv-card-title{font-family:var(--font-display);font-weight:400;font-size:20px;letter-spacing:0;color:var(--brand-white);margin-bottom:5px;line-height:1.1;}
  .iv-card-sub{font-size:12px;color:var(--muted-dark);line-height:1.5;margin-bottom:16px;}
  .iv-card-ft{display:flex;align-items:center;gap:14px;padding-top:14px;border-top:1px solid var(--line);}
  ...
  .iv-lesson-ctr{font-family:var(--font-mono);font-size:10px;color:var(--muted-dark);}
  ...
  .c-vault-text{font-size:13px;color:var(--muted);line-height:1.75;}
  .iv-lesson-footer{display:flex;justify-content:flex-end;padding-top:20px;border-top:1px solid var(--line);}
  ...
  @media(max-width:768px){
    ...
    .iv-lesson-title{font-size:30px;}
    .iv-results-score{font-size:64px;}
      ...
      <div className="iv">
        ...
        <div style={{minHeight:"100vh",display:"grid",placeItems:"center",padding:"40px 20px",position:"relative",zIndex:1}}>
          <div style={{maxWidth:560,width:"100%",background:"var(--ink-soft)",border:"1px solid rgba(118,91,150,0.3)",borderRadius:0,padding:"40px 32px",textAlign:"center"}}>
            ...
            {showReadyHelp && (
              <div style={{marginTop:18,padding:"14px 16px",background:"var(--ink-raised)",border:"1px solid var(--line)",borderRadius:0,textAlign:"left",fontSize:12,color:"var(--muted)",lineHeight:1.6}}>
                <div style={{color:"var(--electric-green)",fontFamily:"var(--font-mono)",fontSize:10,letterSpacing:1,marginBottom:6}}>TROUBLESHOOT</div>
