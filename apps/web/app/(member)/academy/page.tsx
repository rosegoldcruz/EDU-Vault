...
export default function AcademyPage() {
  ...
  if (!scopeLoaded) {
    return (
      <div className="grid place-items-center bg-ink" style={{ minHeight: '100vh' }}>
        <p className="font-mono text-xs text-muted-dark tracking-widest animate-pulse">LOADING ACADEMY ACCESS...</p>
      </div>
    )
  }
